            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        ...
                        <a href="{{url('/Volvo-Service-Center-In-Delhi')}}" class="dropdown-item">Volvo Service Center In Delhi</a>
                    </div>
                </div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="{{url('/top-rated-car-service-and-repair-in-delhi')}}" class="dropdown-item">Top Rated Car Service and Repair in Delhi NCR</a>
                        <a href="{{url('/vehicle-repair-services-in-delhi-ncr')}}" class="dropdown-item">Vehicle Repair Services in Delhi NCR</a>
                        <a href="{{url('/car-service-center-south-delhi')}}" class="dropdown-item">Car Service Center in South Delhi</a>
