...
class HomeController extends Controller
{
    ...
    {
        $data['page_title'] = "Car Service Centre in Delhi Near Me | 24 Hrs Mechanic | Delhi Motors India";
        $data['description'] = "Looking for a reliable car service centre in Delhi near me? Delhi Motors India offers 24 Hrs car mechanic in Delhi NCR, Mechanic on wheels Delhi NCR, and vehicle repair services in Delhi. Visit us in Mohan Estate, Delhi.";
        $data['p_keyword'] = "Car service centre in Delhi near me, 24 Hrs car mechanic in Delhi NCR, Mechanic on wheels Delhi NCR, vehicle repair services in Delhi, Delhi Motors India, car repair Delhi, car maintenance Delhi";
        $data['s_keyword'] = "";
    ...
    public function car_service_center_south_delhi()
    {
        $data['page_title'] = "Car Service Center in South Delhi | Top Car Repair Service in Delhi | Delhi Motors India";
        $data['description'] = "Looking for the best car repair in Mohan Estate? Delhi Motors India offers top vehicle repair services in Delhi NCR with expert technicians, affordable pricing & fast service. Call now!";
        $data['p_keyword'] = "vehicle repair services in delhi, top car repair service in delhi, best car repair in Mohan estate, Popular Car Repair & Services in Delhi NCR";
        $data['s_keyword'] = ""; 
   ...
   public function vehicle_repair_services_in_delhi()
    ...
    public function top_rated_car_service_and_repair_in_delhi()
    {
        $data['page_title'] = "Top Rated Car Service and Repair in Delhi | Best Car Repair in Mohan Estate | Delhi Motors India";        
        $data['description'] = "Looking for the top car repair service in Delhi? Delhi Motors India offers the best car repair in Mohan Estate with expert technicians, genuine parts & affordable car servicing. Book your car service centre in Delhi near you today!";
        $data['p_keyword'] = "best car repair in Mohan estate, car service centre in delhi, car service centre in delhi near me, top car repair service in delhi, car repair workshop delhi, car servicing delhi";
        $data['s_keyword'] = ""; 
        return view('delhi-motors/blog11', $data); 
    }
}
